...
Unfortunately, solutions like [OOP](../oop/do-not-use-inheritance.md), [frameworks](../oop/what-is-the-problem-with-inheritance.md), and [common code that is not common](../data-processing/separate-use-cases.md), create many unwanted dependencies in the code.
